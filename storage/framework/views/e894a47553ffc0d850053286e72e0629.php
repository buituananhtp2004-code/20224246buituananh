            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                    <?php if(auth()->guard()->check()): ?>
                        <span style="color: #e5e7eb; margin-right: 8px;">Xin chào, <?php echo e(Auth::user()->name); ?></span>
                        <a class="button button-secondary" href="<?php echo e(route('students.index')); ?>">Sinh viên</a>
                        <a class="button button-secondary" href="<?php echo e(route('subjects.index')); ?>">Học phần</a>
                        <a class="button button-secondary" href="<?php echo e(route('classrooms.index')); ?>">Lớp học</a>
                        <a class="button button-secondary" href="<?php echo e(route('rooms.index')); ?>">Phòng học</a>
                    ...
                    <?php else: ?>
                        <a class="button button-secondary" href="<?php echo e(route('login')); ?>">Đăng nhập</a>
                        <a class="button button-secondary" href="<?php echo e(route('register')); ?>">Đăng ký</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\admin1\Downloads\quanlysinhvien\quanlysinhvien\resources\views/layouts/app.blade.php ENDPATH**/ ?>